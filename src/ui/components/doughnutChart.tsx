import { Doughnut as DoughnutChartComponent } from 'react-chartjs-2';
import { Chart as ChartJs, ArcElement } from 'chart.js';
import { colors } from '../utils/colors';
import faker from 'faker';
import { getMaximumValue, Time } from '../utils/timeRange';
import { options } from '../features/library/components/tabs/storyboards';
...
export default function DoughnutChart({ chartTitle, labels, time }: Props) {
  const data = {
    labels: labels,
    datasets: [
      {
